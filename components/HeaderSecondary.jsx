  ...
  return (
    <section className="header-secondary">
      <div className="header-logo">
        <a href="http://www.pixellab.ro" title="Thread Affair">
      ...
      <div className="header-search d-lg-none">
        <ul>
          ...
          <li>
            <a href="http://www.pixellab.ro" title="Search">
      ...
      <div className="header-controls">
        <ul>
          <li>
            <a href="http://www.pixellab.ro" title="Cart">
              <i className="fa-solid fa-cart-shopping"></i>
            </a>
          </li>

          <li>
            <a href="http://www.pixellab.ro" title="My Account">
